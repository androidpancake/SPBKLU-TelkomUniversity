...
<div class="flex flex-col bg-gray-50 h-full">
    ...
    <form action="{{ route('booking.done', $id) }}" method="POST" class="h-full">
        @csrf
        <div class="flex flex-col justify-between space-y-2 w-full h-full p-3">
            ...
            <button type="submit" class="px-2.5 py-3 w-full rounded-lg text-white bg-green-500 hover:bg-green-600 font-medium">Selesai</button>
        </div>
    </form>
